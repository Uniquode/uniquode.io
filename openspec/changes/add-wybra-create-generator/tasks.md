...
- [ ] 1.1 Add the `wybra-create` command entry point in Wybra package metadata.
...
- [ ] 2.1 Define the first-pass `wybra-create site` options, including name, title, output path, module list, and config generation choices.
...
- [ ] 2.4 Ensure generated site code uses public Wybra startup APIs and contains no app-owned Wybra environment/config boilerplate.
...
- [ ] 4.1 Add the initial module-template structure for generated modules using Wybra public module boundaries.
...
- [ ] 5.1 Add tests for `wybra-create` dispatch and help/error behaviour.
...
- [ ] 5.5 Document `wybra-create site` usage and the generator extension direction.
