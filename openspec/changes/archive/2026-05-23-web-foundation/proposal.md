...
- Introduce the initial Pico CSS and `htmx` delivery conventions needed by the web foundation architecture.
...
### New Capabilities
- `web-foundation`: Defines the baseline web foundation, including template hierarchy, shared components, static asset delivery, styling entry points, route surface conventions, and pre-runtime web-structure validation expectations.
...
- Affected specs: new `web-foundation` capability and a delta to `application-infrastructure`.
